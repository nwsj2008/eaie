...
public final class TmnewsList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
List list;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\t\t\taction=\"admin/tmszsxt/tmnews/TmnewsDel.jsp\">\r\n");
      ...
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t<a href=\"admin/tmszsxt/tmnews/TmnewsEdit.jsp?id=");
      out.print(tmnews.getId());
      out.write('"');
      out.write('>');
      ...
      out.write("\t\t\t\t\t\t<input type=\"button\" name=\"Submit2\" value=\"添加推免生通知\"\r\n");
      out.write("\t\t\t\t\t\t\tonClick=\"location.href='TmnewsAdd.jsp'\">\r\n");
      out.write("\t\t\t\t\t\t&nbsp; &nbsp;\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\r\n");
