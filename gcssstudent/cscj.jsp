...
<div id="page">
	...
	<table>
		<tr height="40px">
			<td  align="right"><b>GCT</b>&nbsp;成绩&nbsp;&nbsp;：</td>
			<td align="left" ><%=gcssuser.getGct() %></td>
		</tr>
		<tr height="40px">
			<td width="120px" align="right">工程领域&nbsp;&nbsp;：</td>
			<td align="left" ><%= gcssuser.getGcly() %><br></td>
		</tr>
