...
import java.util.*;
import com.eaie.sbldxt.sbldstudent.SbldstudentList;

public final class SbstudentListSq_jsp extends org.apache.jasper.runtime.HttpJspBase
...
List list;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\t\t<title>硕博连读生申请信息查询</title>\r\n");
      ...
      out.write("\t\t\taction=\"admin/sbldxt/sbldstudent/SbstudentDel.jsp\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\tvalue=\"");
      out.print(sbld.getId());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<div style=\"width: 50px; overflow: hidden;text-overflow:ellipsis;\">\r\n");
      out.write("\t\t\t\t\t<nobr>\r\n");
      out.write("\t\t\t\t\t\t<a href=\"admin/sbldxt/sbldstudent/SbstudentList.jsp?id=");
      out.print(sbld.getId());
      out.write('"');
      out.write('>');
      ...
      out.write("\t\t\t\t\t\t选取所有的硕博连读生&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t<input type=\"submit\" name=\"Submit\" value=\"删除所选条目\"\r\n");
      out.write("\t\t\t\t\t\t\tonclick=\"{if(confirm('确定删除选中的硕博连读生吗？')){return true;}return false;}\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\r\n");
