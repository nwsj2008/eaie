...
public final class uploadxls_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String sFileName, sFileUrl,sFileSize, sAction;
  ...
  request.setCharacterEncoding("GBK");
	...
	sAction = request.getParameter("action");
      ...
      out.write("\t\t   \t}\r\n");
      out.write("\t\t   \tif (name!=\".xls\")   \r\n");
      out.write("\t\t\t{   \r\n");
      out.write("\t\t\t\talert(\"限制上传的文件类型为xls！\");   \r\n");
      out.write("\t\t\t\treturn false;   \r\n");
      out.write("\t\t\t}   \r\n");
      out.write("\t\t   \t\r\n");
      out.write("\t\t  }\r\n");
	...
	if (sAction == null) {
      ...
      out.write("\r\n");
      out.write("\t<form name=\"upfile\" type=\"file\" method=\"post\" action=\"upload/uploadxls.jsp?action=save\"\r\n");
      ...
      out.write("\t");
		...
		if (sAction.equalsIgnoreCase("save")) {
			...
			if (!IsMissing) {
				...
				String FileUrl = "/UploadFiles/upfile/" + "bs.xls";
      ...
      out.write("\t");
				...
				out.println("上传失败！请重新上传。&nbsp;<A href=\"upload/uploadxls.jsp\">上传</A>");	
			}	
		}
		if (sAction.equalsIgnoreCase("show")) {		
		 	...
		 	if(sFileName==null||sFileUrl==null){	
		 		...
		 		out.print("<script> window.location.href='uploadxls.jsp'</script>");		 	
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t<form name=showfile type=file method=post action=\"upload/uploadxls.jsp?action=delete\">\t    \r\n");
      out.write("\t\t<table border=0 cellpadding=0 cellspacing=0 align=left width=\"100%\">\r\n");
      out.write("\t\t\t<tr>\t\t\t\t\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t \t");
      ...
      out.write("\t");
		...
		if(sAction.equalsIgnoreCase("delete")){			
			...
			if(sFileUrl!=null){
				...
				String filepath = config.getServletContext().getRealPath("/UploadFiles/upfile/"+"bs.xls");				
				...
				if(filetodel.exists()){
					...
					if(delok){	
						...
						out.println(JavaScript.alertandRedirect("删除成功！","uploadxls.jsp"));	
					}else{						
