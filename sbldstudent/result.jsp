...
<div id="page">
	<div id="header">
			<h1 align="center">电子信息工程学院硕博连读招生系统</h1>
	</div>	
	<div id="mainarea">
	<div id="sidebar">
		<div id="sidebarnav">
		...
		<a href="application/ApplicationEdit.jsp?id=<%=sbldUser.getId() %>">修改申请</a>
	...
	<table>
		<tr height="40px">
			...
			<td align="left" valign="top"><h2><%= (sbldUser.getLqlb()==null)?"": sbldUser.getLqlb()%></h2></td>
		</tr>
		
		<tr height="40px">
			<td valign="top" align="right"><h2>录取专业：</h2></td>
			<td align="left" valign="top"><h2><%= (sbldUser.getLqzy()==null)?"": sbldUser.getLqzy() %></h2></td>
		</tr>
		<tr height="40px" >
			<td valign="top" align="right"><h2>导师信息：</h2></td>
			<td align="left" valign="top"><h2><%= (sbldUser.getDsxx()==null)?"": sbldUser.getDsxx() %></h2></td>
		</tr>
	</table>
		<br><br>
	</div>
