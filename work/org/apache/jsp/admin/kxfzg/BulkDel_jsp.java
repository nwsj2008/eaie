...
public final class BulkDel_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("    ");
 try{
           boolean isDone = kxfzgNews.bulkDel(request.getParameterValues("ele"));
           if(isDone)
