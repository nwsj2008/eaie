...
public final class InfoReply_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\t\t<form name=\"userform\" method=\"post\" action=\"admin/kxfzg/InfoReplySave.jsp\">\r\n");
      ...
      out.write("                   <td width=\"50%\">题目：");
      out.print(info.getTitle()==null?"":info.getTitle());
      out.write("</td>\r\n");
      out.write("                   <td>留言人IP： </td>\r\n");
      out.write("                </tr>\r\n");
      out.write("\t\t\t\t <tr class=\"tdbg\">\r\n");
      out.write("     \t\t\t\t<td>时间：");
      out.print(info.getPubtime()==null?"":info.getPubtime());
      out.write("</td>\r\n");
      out.write("     \t\t\t\t <td>留言人：");
      out.print(info.getWriter()==null?"":info.getWriter());
      out.write("</td>\r\n");
      out.write("  \t\t\t\t  </tr>\r\n");
      out.write("   \t\t\t\t <tr class=\"tdbg\">\r\n");
      out.write("    \t\t\t\t  <td colspan=\"2\">内容：");
      out.print(info.getContent()==null?"":info.getContent());
      out.write("</td>\r\n");
      out.write("   \t\t\t\t </tr>\r\n");
      out.write("    \t\t\t\t<tr class=\"tdbg\">\r\n");
      out.write("     \t\t\t\t <td colspan=\"2\">回复：\r\n");
      out.write("     \t\t\t\t <textarea name=\"reply\" id=\"reply\" cols=\"60\" rows=\"12\" >");
      out.print(info.getAnswer()==null?"":info.getAnswer());
      ...
      out.write("\t\t\t\t\t\t&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t<input type=\"button\" name=\"Submit2\" value=\"取 消\" onclick=\"javascript:window.location.href='LookInfo.jsp'\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\t\t\t\t\r\n");
      out.write("\t\t</form>\r\n");
