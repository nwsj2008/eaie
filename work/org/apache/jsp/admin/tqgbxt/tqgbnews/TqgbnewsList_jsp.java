...
public final class TqgbnewsList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
List list;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\t\t<title>所有提前攻博生通知</title>\r\n");
      ...
      out.write("\t\t\taction=\"admin/tqgbxt/tqgbnews/TqgbnewsDel.jsp\">\r\n");
      ...
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t<a href=\"admin/tqgbxt/tqgbnews/TqgbnewsEdit.jsp?id=");
      out.print(tqgbnews.getId());
      out.write('"');
      out.write('>');
      ...
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(dateFormatStart.format(tqgbnews.getPubtime()==null?new Date():tqgbnews.getPubtime()));
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t<input type=\"button\" name=\"Submit2\" value=\"添加提前攻博生通知\"\r\n");
      out.write("\t\t\t\t\t\t\tonClick=\"location.href='TqgbnewsAdd.jsp'\">\r\n");
      out.write("\t\t\t\t\t\t&nbsp; &nbsp;\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\r\n");
