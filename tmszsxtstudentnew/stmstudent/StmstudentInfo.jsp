					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td style="padding: 0 20px 10px 25px" valign="top">
								<p>
									<span class="titlebold2">查看个人申请信息</span>
									<br>
								...
								<form name="form1" method="post"
									...
									<table align="center">
										...
										<tr>
											...
											<td>
												<%=(tmstudent.getName() == null) ? "" : tmstudent
						.getName()%>
											</td>
										...
										<tr>
											...
											<td>
												<%=(tmstudent.getTel() == null) ? "" : tmstudent
						.getTel()%>
											</td>
										</tr>
										<tr>
						...
						: tmstudent.getJsacademe()%>
										...
										<tr>
											...
											<td>
												<%=(tmstudent.getJsspeciality() == null) ? ""
						...
						style="background-color:#e9f2f9;"> <%=(tmstudent.getHuoj() == null) ? ""
