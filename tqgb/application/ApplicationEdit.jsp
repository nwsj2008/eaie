...
<html>
	...
	<head>
		...
		<LINK REL=StyleSheet HREF="../tqgbstyle.css" TYPE="text/css"
			MEDIA=screen>
							...
							<tr>
								...
								<td>
									<input name="name" type="text" id="name" size="30"
										value="<%=(tqgbstudent.getName() == null) ? ""
						: tqgbstudent.getName()%>">
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="number" type="text" id="number" size="30"
										value="<%=(tqgbstudent.getXuehao() == null) ? ""
						: tqgbstudent.getXuehao()%>">
							...
							<tr>
								...
								<%
									  ...
									  else if (tqgbstudent.getSex().equals("男")) 
								    {
								%>
								<td>
							...
							<tr>
								...
								<td>
									<input name="master" type="text" id="master" size="30"
										value="<%=(tqgbstudent.getSszy() == null) ? ""
						: tqgbstudent.getSszy()%>">
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="doctor" type="text" id="doctor" size="30"
										value="<%=(tqgbstudent.getNbzy() == null) ? ""
						: tqgbstudent.getNbzy()%>">
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="masterTeacher" type="text" id="masterTeacher"
										size="30"
										value="<%=(tqgbstudent.getSd() == null) ? "" : tqgbstudent
						.getSd()%>">
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="doctorTeacher" type="text" id="doctorTeacher"
										size="30"
										value="<%=(tqgbstudent.getNbbd() == null) ? ""
						: tqgbstudent.getNbbd()%>">
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<input name="cjpm" type="text" id="cjpm" size="30"
										value="<%=(tqgbstudent.getCjpm() == null) ? ""
						: tqgbstudent.getCjpm()%>">
								</td>
							</tr>
							<tr>
								...
								<td>
									<textarea name="beizhu" rows="5" cols="30"
										onKeyDown='if (this.value.length>=100){event.returnValue=false}'><%=(tqgbstudent.getBeizhu() == null) ? ""
