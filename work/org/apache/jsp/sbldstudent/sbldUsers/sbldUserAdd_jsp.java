package org.apache.jsp.sbldstudent.sbldUsers;
...
import org.apache.jsp.sbldstudent.sbldLogin_jsp;

public final class sbldUserAdd_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t{\r\n");
      out.write("\t\t\tif (document.Login.sbldusername.evalue==\"\")\r\n");
      out.write("\t\t\t\tdocument.Login.sbldusername.focus();\r\n");
      out.write("\t\t\telse\r\n");
      out.write("\t\t\t\tdocument.Login.sbldusername.select();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tfunction CheckForm()\r\n");
      out.write("\t\t\t{\r\n");
      out.write("\t\t\t\tif(document.Login.sbldusername.value==\"\")\r\n");
      out.write("\t\t\t\t{\r\n");
      out.write("\t\t\t\t\talert(\"请输入用户名！\");\r\n");
      out.write("\t\t\t\t\tdocument.Login.sbldusername.focus();\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tif(document.Login.sbldpassword.value == \"\")\r\n");
      out.write("\t\t\t\t{\r\n");
      out.write("\t\t\t\t\talert(\"请输入密码！\");\r\n");
      out.write("\t\t\t\t\tdocument.Login.sbldpassword.focus();\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\tfunction CheckForm(){\t\r\n");
      out.write("\t\t     \r\n");
      out.write("\t\t\t if(!isNull(\"sbldusername\",\"用户名\"))\r\n");
      out.write("\t\t\t {\r\n");
      out.write("\t\t\t \treturn false;\r\n");
      out.write("\t\t\t }\t\t\t\r\n");
      out.write("\t\t\t if(!isNull(\"sbldpassword\",\"密码\"))\r\n");
      out.write("\t\t\t {\r\n");
      out.write("\t\t\t \treturn false;\r\n");
      out.write("\t\t\t }\r\n");
      out.write("\t\t\t if(!isNull(\"sbldpassword2\",\"重复密码\"))\r\n");
      out.write("\t\t\t {\r\n");
      out.write("\t\t\t \treturn false;\r\n");
      out.write("\t\t\t }\r\n");
      out.write("\t\t\t if(!isEqual(\"sbldpassword\",\"sbldpassword2\",\"两次输入密码不一致！\"))\r\n");
      out.write("\t\t\t {\r\n");
      out.write("\t\t\t \treturn false;\r\n");
      out.write("\t\t\t }\t\r\n");
      out.write("\t\t\t var num; \r\n");
      ...
      out.write("  \r\n");
      out.write("<body>\r\n");
      out.write("\t\t<form name=\"Login\" method=\"post\" action=\"sbldstudent/sbldUsers/sbldUserSave.jsp\"\r\n");
      out.write("\t\t\tonSubmit=\"return CheckForm();\" >\r\n");
      out.write("\t\t\t<table width=\"331\" border=\"0\" align=\"center\" cellpadding=\"0\"\r\n");
      out.write("\t\t\t\tcellspacing=\"0\">\t\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"3\">\r\n");
      out.write("\t\t\t\t\t\t<img src=\"admin/images/sbld.gif\" width=\"762\" height=\"125\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"sbldusername\" type=\"text\" class=\"textinput\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"sbldusername\" onFocus=\"this.select(); \" maxlength=\"12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td align=\"right\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"sbldpassword\" type=\"password\" class=\"textinput\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"sbldpassword\" onFocus=\"this.select(); \" maxlength=\"15\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td align=\"right\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"sbldpassword2\" type=\"password\" class=\"textinput\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"sbldpassword2\" onFocus=\"this.select(); \" maxlength=\"15\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"2\">\r\n");
