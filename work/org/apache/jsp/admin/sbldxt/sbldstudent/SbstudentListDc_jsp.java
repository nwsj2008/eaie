...
public final class SbstudentListDc_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//List list;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\t\t<title>硕博连读生信息列表</title>\r\n");
 ...
 // String hql="SELECT id FROM Tmstudent";
  ...
  out.print("没有记录");
      ...
      out.write("\t\t\taction=\"admin/sbldxt/sbldstudent/SbstudentExcel.jsp\">\r\n");
      ...
      out.write("\t\t\t\t\t<div style=\"width: 100px; overflow: hidden;text-overflow:ellipsis;\">\r\n");
      out.write("\t\t\t\t\t<nobr>\r\n");
      out.write("\t\t\t\t\t<input name=\"bkzy\" id=\"bkzy\" type=\"hidden\" value=\"");
      ...
      out.write("\t\t\t\t\t<div style=\"width: 50px; overflow: hidden;text-overflow:ellipsis;\">\r\n");
      out.write("\t\t\t\t\t<nobr>\r\n");
      out.write("\t\t\t\t\t<input name=\"rxcj\" id=\"rxcj\" type=\"hidden\" value=\"");
