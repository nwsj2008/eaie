...
public final class BsnewsEdit_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
  ...
  Bsnews bsnews=(Bsnews)list.get(0);
      ...
      out.write("\t\t\taction=\"admin/bszsxt/bsnews/BsnewsUpate.jsp\">\r\n");
      ...
      out.print(bsnews.getContent()==null?"":HtmlEncode.htmlEncode(bsnews.getContent()));
      out.write("\">\r\n");
      ...
      out.print(bsnews.getFilename() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t<input type=hidden name=\"fileurl\" value=\"");
      out.print(bsnews.getFileurl() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t<iframe id=d_file frameborder=0 src=\"upload/uploadfile.jsp?action=show&filename=");
      out.print((bsnews.getFilename()==null)?"":bsnews.getFilename() );
      out.write("&fileurl=");
      out.print((bsnews.getFileurl()==null)?"":bsnews.getFileurl() );
      out.write("\"\r\n");
      ...
      out.write("\t\t\t\t\t\t&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t<input type=\"button\" name=\"back\" value=\"返&nbsp;回\"  onClick=\"window.location.href='BsnewsList.jsp'\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t</form>\r\n");
