...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\">\r\n");
      out.write("    \r\n");
      out.write("    <title>科学发展观学习的所有内容</title>\r\n");
      out.write("    \r\n");
     ...
     int curPage=(request.getParameter("curPage")==null?1:Integer.parseInt(request.getParameter("curPage")));
      ...
      out.write("\r\n");
      out.write(" \r\n");
      out.write("<form name=\"mainForm\" method=\"post\" action=\"admin/kxfzg/BulkDel.jsp\" onSubmit=\"return checkBulk()\">\r\n");
  ...
  SimpleDateFormat dateFormatStart = new SimpleDateFormat("yyyy-MM-dd");  
    ...
    while (it.hasNext()) {
      ...
      out.print(n.getId());
      out.write("\"></td>\r\n");
      out.write("    <td><a href=\"admin/kxfzg/NewsEdit.jsp?id=");
      out.print(n.getId());
      out.write('"');
      out.write(' ');
      out.write('>');
      ...
      out.print(n.getPart() );
      out.write("</td>\r\n");
      out.write("    <td align=\"center\"><a href=\"admin/kxfzg/NewsEdit.jsp?id=");
      out.print(n.getId());
      out.write("\">编辑</a>&nbsp;&nbsp;<a href=\"admin/kxfzg/NewsDel.jsp?id=");
      out.print(n.getId() );
      ...
      out.write(" \r\n");
      out.write(" \r\n");
      out.write(" <form name=\"pageForm\" action=\"admin/kxfzg/NewsList.jsp\" method=\"post\">   \r\n");
