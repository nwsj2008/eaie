...
public final class BsstudentList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
List list;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\t\t\taction=\"admin/bszsxt/bsstudent/BsstudentDaoru.jsp\">\r\n");
      ...
      out.write("\t\t\t\t\t<nobr>\r\n");
      out.write("\t\t\t\t\t\t");
      out.print((bsstudent.getPwd() == null) ? ""
							: bsstudent.getPwd());
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</nobr></div>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t<iframe id=d_file frameborder=0 src=\"upload/uploadxls.jsp\"\r\n");
      ...
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr><td>注意：上传文件类型为xls,包含姓名,身份证 ,报考专业 ,报考导师，外语，业务课1，业务课2，总分八列  &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type=\"button\" name=\"Submit2\" value=\"下载模板\"\r\n");
