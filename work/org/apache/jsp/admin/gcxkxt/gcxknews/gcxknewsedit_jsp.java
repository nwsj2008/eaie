...
public final class gcxknewsedit_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t<title>修改工程硕士通知</title>\r\n");
      out.write("\t\t<base href=\"");
      out.print(basePath);
      out.write("\">\r\n");
  ...
  Gcxknews gcxkbnews=(Gcxknews)list.get(0);
      ...
      out.write("\t\t\taction=\"admin/gcxkxt/gcxknews/gcxknewsupdate.jsp\">\r\n");
      ...
      out.print(gcxkbnews.getContent()==null?"":HtmlEncode.htmlEncode(gcxkbnews.getContent()));
      out.write("\">\r\n");
      ...
      out.print(gcxkbnews.getFilename() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t<input type=hidden name=\"fileurl\" value=\"");
      out.print(gcxkbnews.getFileurl() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t<iframe id=d_file frameborder=0 src=\"upload/uploadfile.jsp?action=show&filename=");
      out.print((gcxkbnews.getFilename()==null)?"":gcxkbnews.getFilename() );
      out.write("&fileurl=");
      out.print((gcxkbnews.getFileurl()==null)?"":gcxkbnews.getFileurl() );
      out.write("\"\r\n");
