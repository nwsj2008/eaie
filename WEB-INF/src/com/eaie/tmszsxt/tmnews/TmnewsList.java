package com.eaie.tmszsxt.tmnews;

import java.util.List;

import com.eaie.common.Page;

public class TmnewsList {
	...
	public TmnewsList() {
		...
		page = new Page();
		pageHQL = "FROM Tmnews";
		countHQL = "SELECT COUNT(*) FROM Tmnews";
	}

	public List getTmnewsList(int pageIndex, String csearchpart, String cKeyWords) {
		...
		page.setMaxPageNum(countHQL, "Tmnews");
