		...
		<form action="index.jsp" method="post">
			     <table   cellspacing="4" cellpadding="4">
										...
										<tr>
											...
											<td>
												<input name="Bname" type="text" class="textinput"
													id="Bname" onFocus="this.select(); " maxlength="12">
											</td>
										</tr>
										<tr>
											<td align="right">
											...
											<td>
												<input name="Bassword" type="password" class="textinput"
													id="Bpassword" onFocus="this.select(); " maxlength="15">
											</td>
										</tr>
										<tr align="center">
											<td colspan="2">
