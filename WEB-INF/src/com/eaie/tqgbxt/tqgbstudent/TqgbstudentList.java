package com.eaie.tqgbxt.tqgbstudent;
import java.util.List;
import com.eaie.common.Page;

public class TqgbstudentList {
	private static Page page;
	private String pageHQL;
	private String countHQL;	
	
	public  TqgbstudentList(){	
		
		page = new Page();		
		pageHQL = "FROM Tqgb";
		countHQL ="SELECT COUNT(*) FROM Tqgb";
	}
	
	public List getTqgbstudentList(int pageIndex,String csearchpart,String cKeyWords){
		...
		page.setMaxPageNum(countHQL, "Tqgbstudent");					
