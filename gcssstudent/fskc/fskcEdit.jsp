...
<html>
	...
	<div id="sidebar">
		...
		<a class="active" href="fskcEdit.jsp">修改复试课程</a>
						...
						<table align="center">
							...
							<tr height="50px">
								<td>
								 ...
								 <% if(gcssstudent.getZyk().equals("通信系统原理")) {%>
								<td>
								...
								<%
									  ...
									  else if (gcssstudent.getZyk().equals("自动控制原理")) 
								    {
								%>
								<td>
									<input type="radio" name="fskc" value="1"  >
									通信系统原理
									<input type="radio" name="fskc" value="2" checked="checked">
									自动控制原理
									<input type="radio" name="fskc" value="3">
									计算机网络及其应用	
								</td>
								<%
									  ...
									  else if (gcssstudent.getZyk().equals("计算机网络及其应用")) 
								    {
								%>
								<td>
									<input type="radio" name="fskc" value="1"  >
									...
									<input type="radio" name="fskc" value="2">
									自动控制原理
									<input type="radio" name="fskc" value="3" checked="checked">
									计算机网络及其应用	
								</td>
								<%} %>
							<tr height="50px">
