...
public final class GcstudentList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
List list;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\t\t\taction=\"admin/gcxkxt/gcxkstudent/GcstudentDel.jsp\">\r\n");
      ...
      out.write("\t\t\t\t\t<nobr>\r\n");
      out.write("\t\t\t\t\t\t<a\r\n");
      out.write("\t\t\t\t\t\t\thref=\"admin/gcxkxt/gcxkstudent/GcstudentEdit.jsp?id=");
      out.print(gcstudent.getId());
      out.write('"');
      out.write('>');
      ...
      out.write("\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t<table width=\"60%\" border=\"0\" align=\"center\" cellpadding=\"6\"\r\n");
      ...
      out.write("\t\t\t\t\t\t选取所有的学生信息&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t<input type=\"submit\" name=\"Submit\" value=\"删除所选的学生信息\"\r\n");
      out.write("\t\t\t\t\t\t\tonclick=\"{if(confirm('确定删除选中的学生信息吗？')){return true;}return false;}\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"button\" name=\"Submit2\" value=\"添加学生信息\"\r\n");
      out.write("\t\t\t\t\t\t\tonClick=\"location.href='Newstudent.jsp'\">\r\n");
      out.write("\t\t\t\t\t\t&nbsp; &nbsp;\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\r\n");
