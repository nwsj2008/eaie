	...
	//没有用户登录
		...
		if(tqgbUserName!=null&&tqgbPassWord!=null){
			try{
			 	...
			 	if(tqgbuser!=null){	
			 		session.setAttribute("id",tqgbuser.getId());//得到用户的id，将id付给字符串"id"
										...
										<tr align="center">
											...
											&nbsp;&nbsp;&nbsp;&nbsp;
												<input name="Submit2" type="reset" class="submitinput"
													...
													value="重&nbsp;置">
								     &nbsp;&nbsp;&nbsp;&nbsp;
												<input type="button" name="back"  class="submitinput" value="注&nbsp;册" onClick="window.location.href='tqgbUsers/tqgbUserAdd.jsp'"
												onMouseOver="this.style.backgroundColor='#ffffff'"
													onMouseOut="this.style.backgroundColor='#E1F4EE'">
