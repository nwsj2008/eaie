...
<html>
  	...
  	<td>	
  		...
  		<table width="100%" align="center">
  			<tr>
  				...
  				<td valign="bottom"><div class="search">&nbsp;&nbsp;<strong><font color="000000">新闻</font></strong>&nbsp;&nbsp;<a href="search/SearchPeo.jsp" style="text-decoration:underline"><font color="#0000CD">用户</font></a>&nbsp;&nbsp;<a href="search/SearchFile.jsp" style="text-decoration:underline"><font color="#0000CD">文件</font></a></div></td>
  			</tr>
  			<tr>
  ...
  <tr>
  	<td>
  		<table width="580px" style="margin-left:12px">
  			...
  			<tr>
  				<td><div class="searchInfo">文章类别:<%=news.getSmallclass()%>&nbsp;发布时间:<%=DateTimeFormat.getDateString(news.getPubtime())%>&nbsp;浏览次数:<%=news.getHits()%></div></td>
  			</tr>
  			<tr>
  				<td>&nbsp;</td>
  			</tr>
  ...
  <td valign="top" class="searchContent">
  		<table cellpadding="0" cellspacing="0">
  			<tr>
  				<td class="search_td">找到相关文件:<font color="red"><%=search.getDocListSize() %></font>个</td>
  			</tr>	
  			<tr>
