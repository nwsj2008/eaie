							...
							<tr>
								...
								<td>
									<input name="name" type="text" id="name" size="30"
										value="<%=(sbldstudent.getName() == null) ? ""
						: sbldstudent.getName()%>">
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="number" type="text" id="number" size="30"
										value="<%=(sbldstudent.getXuehao() == null) ? ""
						: sbldstudent.getXuehao()%>">
							...
							<tr>
								...
								<%
									  ...
									  else if (sbldstudent.getSex().equals("男")) 
								    {
								%>
								<td>
							...
							<tr>
								...
								<td>
									<input name="master" type="text" id="master" size="30"
										value="<%=(sbldstudent.getSszy() == null) ? ""
						: sbldstudent.getSszy()%>">
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="doctor" type="text" id="doctor" size="30"
										value="<%=(sbldstudent.getBbzy() == null) ? ""
						: sbldstudent.getBbzy()%>">
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="masterTeacher" type="text" id="masterTeacher"
										size="30"
										value="<%=(sbldstudent.getSd() == null) ? "" : sbldstudent
						.getSd()%>">
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="doctorTeacher" type="text" id="doctorTeacher"
										size="30"
										value="<%=(sbldstudent.getNbbd() == null) ? ""
						: sbldstudent.getNbbd()%>">
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<input name="score" type="text" id="score" size="30"
										value="<%=(sbldstudent.getRxcj() == null) ? ""
						: sbldstudent.getRxcj()%>">
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="cjpm" type="text" id="cjpm" size="30"
										value="<%=(sbldstudent.getCjpm() == null) ? ""
						: sbldstudent.getCjpm()%>">
								</td>
							</tr>
							<tr>
								...
								<td>
									<textarea name="beizhu" rows="5" cols="30"
										onKeyDown='if (this.value.length>=100){event.returnValue=false}'><%=(sbldstudent.getBeizhu() == null) ? ""
