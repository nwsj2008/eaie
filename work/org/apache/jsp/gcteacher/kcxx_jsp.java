...
public final class kcxx_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Gcteacher gcteacher = (Gcteacher)session.getAttribute("GCTEACHER");
      ...
      out.write("老师,你好：</h2>\r\n");
      out.write("\t\t<form name=\"form1\" method=\"post\" action=\"kcxx.jsp\">\r\n");
 ...
 if (nianfen!=null&&(nianfen.equals(year)))
      ...
      out.write("\t\t</form>\r\n");
      out.write("\t\t<form method=\"post\" action=\"kcdetail.jsp\">\r\n");
...
List listb = BasicDAO
      ...
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t<a href=\"kcdetail.jsp?id=");
      out.print(courseid );
      out.write("\">查看</a>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
