package org.apache.jsp.gcssstudent;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;
import com.eaie.dbmanage.*;
import com.eaie.admin.gcssusers.*;
import com.eaie.tools.*;
import com.eaie.admin.gcssusers.GcssuserManage;

public final class gcsslogin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
   ...
   //	}
	...
	//没有用户登录
      ...
      out.write("\t\t\t{\r\n");
      out.write("\t\t\tif (document.Login.gcssusername.value==\"\")\r\n");
      out.write("\t\t\t\tdocument.Login.gcssusername.focus();\r\n");
      out.write("\t\t\telse\r\n");
      out.write("\t\t\t\tdocument.Login.gcssusername.select();   //选中文本框的文字，变成蓝底白字\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tif(document.Login.gcsspassword.value == \"\")\r\n");
      out.write("\t\t\t\t{\r\n");
      out.write("\t\t\t\t\talert(\"请输入身份证号！\");\r\n");
      out.write("\t\t\t\t\tdocument.Login.gcsspassword.focus();\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t<img src=\"admin/images/gcss.gif\" width=\"762\" height=\"125\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"gcssusername\" type=\"text\" class=\"textinput\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"gcssusername\" onFocus=\"this.select(); \" maxlength=\"500\">    \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"gcsspassword\" type=\"password\" class=\"textinput\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"gcsspassword\" onFocus=\"this.select(); \" maxlength=\"500\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"2\">\r\n");
