					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td style="font-size: 12px;padding: 0 20px 10px 25px" valign="top">
								<p>
									<span class="titlebold2">修改个人申请信息</span>
									<br>
                      ...
                      <tr>
											<td align="center">									
												...
												<input name="name" type="text" id="name" size="30"
													value="<%=(tmstudent.getName() == null) ? "" : tmstudent
						.getName()%>">
												</td>
												</tr>
												<tr>
												...
												<input name="tel" type="text" id="tel" size="30"
													value="<%=(tmstudent.getTel() == null) ? "" : tmstudent
						.getTel()%>">
												</td>
												</tr>
												<tr>
												...
												<input name="byschool" type="text" id="byschool" size="30"
													value="<%=(tmstudent.getByschool() == null) ? ""
						: tmstudent.getByschool()%>">
												...
												<input name="byspeciality" type="text" id="byspeciality"
													size="30"
													value="<%=(tmstudent.getByspeciality() == null) ? ""
						: tmstudent.getByspeciality()%>">
												...
												<input name="jsacademe" type="text" id="jsacademe" size="30"
													value="<%=(tmstudent.getJsacademe() == null) ? ""
						: tmstudent.getJsacademe()%>">
												</td>
												</tr>
												<tr>
												<td>
												...
												<input name="jsspeciality" type="text" id="jsspeciality"
													size="30"
													value="<%=(tmstudent.getJsspeciality() == null) ? ""
						: tmstudent.getJsspeciality()%>">				
											</td>
											</tr>
											<tr>
												<td>
												...
												<td>
												<input name="siji" type="text" id="siji"
													size="30"
													value="<%=(tmstudent.getSiji() == null) ? ""
						: tmstudent.getSiji()%>">				
											</td>
											</tr>
											<tr>
												...
												<td>
												<input name="liuji" type="text" id="liuji"
													size="30"
													value="<%=(tmstudent.getLiuji() == null) ? ""
						: tmstudent.getLiuji()%>">				
											</td>
											</tr>
											<tr>
												...
												<td>
												<input name="zypm" type="text" id="zypm"
													size="30"
													value="<%=(tmstudent.getZypm() == null) ? ""
						: tmstudent.getZypm()%>">				
											</td>
											</tr>
											<tr>
												...
												<td>
												<input name="zyrs" type="text" id="zyrs"
													size="30"
													value="<%=(tmstudent.getZyrs() == null) ? ""
						: tmstudent.getZyrs()%>">				
											</td>
											</tr>
											<tr>
						...
						<textarea name="huoj" rows="5" cols="30" onKeyDown='if (this.value.length>=100){event.returnValue=false}'> <%=(tmstudent.getHuoj() == null) ? ""
						: tmstudent.getHuoj()%></textarea>	
									...
									<center>
				<input type="submit" name="Submit" value="修&nbsp;&nbsp;改" onclick="return formCheck()">&nbsp;&nbsp;&nbsp;
