...
public final class sbldLogin_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
	...
	//没有用户登录
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"sbldusername\" onFocus=\"this.select(); \" maxlength=\"500\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td align=\"right\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"sbldpassword\" onFocus=\"this.select(); \" maxlength=\"500\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"2\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvalue=\"重&nbsp;置\">\r\n");
      out.write("\t\t\t\t\t\t\t\t     &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"button\" name=\"back\"  class=\"submitinput\" value=\"注&nbsp;册\" onClick=\"window.location.href='sbldUsers/sbldUserAdd.jsp'\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tonMouseOver=\"this.style.backgroundColor='#ffffff'\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tonMouseOut=\"this.style.backgroundColor='#E1F4EE'\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
