package org.apache.jsp.admin.tqgbxt.tqgbnews;
...
import com.eaie.tqgbxt.tqgbnews.*;

public final class TqgbnewsEdit_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t<title>修改提前攻博生通知</title>\r\n");
      out.write("\t\t<base href=\"");
      out.print(basePath);
      out.write("\">\r\n");
  ...
  Tqgbnews tqgbnews=(Tqgbnews)list.get(0);
      ...
      out.write("\t\t\taction=\"admin/tqgbxt/tqgbnews/TqgbnewsUpate.jsp\">\r\n");
      ...
      out.print(tqgbnews.getContent()==null?"":HtmlEncode.htmlEncode(tqgbnews.getContent()));
      out.write("\">\r\n");
      ...
      out.print(tqgbnews.getFilename() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t<input type=hidden name=\"fileurl\" value=\"");
      out.print(tqgbnews.getFileurl() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t<iframe id=d_file frameborder=0 src=\"upload/uploadfile.jsp?action=show&filename=");
      out.print((tqgbnews.getFilename()==null)?"":tqgbnews.getFilename() );
      out.write("&fileurl=");
      out.print((tqgbnews.getFileurl()==null)?"":tqgbnews.getFileurl() );
      out.write("\"\r\n");
      ...
      out.write("\t\t\t\t\t\t&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t<input type=\"button\" name=\"back\" value=\"返&nbsp;回\"  onClick=\"window.location.href='TqgbnewsList.jsp'\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t</form>\r\n");
