...
<body>
	...
	%>
	<form name="upfile" type="file" method="post" action="upload/uploadxls.jsp?action=save"
	...
	<form name=showfile type=file method=post action="upload/uploadxls.jsp?action=delete">	    
		<table border=0 cellpadding=0 cellspacing=0 align=left width="100%">
			<tr>				
				<td>
