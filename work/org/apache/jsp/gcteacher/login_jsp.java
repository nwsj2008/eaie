  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
   ...
   //	}
	...
	//没有用户登录
      ...
      out.write("\t\t\t{\r\n");
      out.write("\t\t\tif (document.Login.gcteachername.evalue==\"\")\r\n");
      out.write("\t\t\t\tdocument.Login.gcteachername.focus();\r\n");
      out.write("\t\t\telse\r\n");
      out.write("\t\t\t\tdocument.Login.gcteachername.select();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tfunction CheckForm()\r\n");
      out.write("\t\t\t{\r\n");
      out.write("\t\t\t\tif(document.Login.gcteachername.value==\"\")\r\n");
      out.write("\t\t\t\t{\r\n");
      out.write("\t\t\t\t\talert(\"请输入姓名！\");\r\n");
      out.write("\t\t\t\t\tdocument.Login.gcteachername.focus();\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tif(document.Login.gcteacherpwd.value == \"\")\r\n");
      out.write("\t\t\t\t{\r\n");
      out.write("\t\t\t\t\talert(\"请输入密码！\");\r\n");
      out.write("\t\t\t\t\tdocument.Login.gcteacherpwd.focus();\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t<table width=\"777\" border=\"0\" align=\"center\" cellpadding=\"0\"\r\n");
      out.write("\t\t\t\tcellspacing=\"0\">\t\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"3\">\r\n");
      out.write("\t\t\t\t\t\t<img src=\"/eaie/gcteacher/images/header.gif\" width=\"750\" height=\"120\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\t\t\t\r\n");
      out.write("\t\t\t\t<tr >\r\n");
      out.write("\t\t\t\t<td width=\"268\">\r\n");
      out.write("\t\t\t\t\t\t<img src=\"/eaie/gcteacher/images/left.gif\"  width=\"268\" height=\"194\">\r\n");
      out.write("\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<table width=\"100%\" border=\"0\" cellspacing=\"4\" cellpadding=\"4\"  align=\"center\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"gcteachername\" type=\"text\" class=\"textinput\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"gcteachername\" onFocus=\"this.select(); \" maxlength=\"500\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td align=\"right\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"gcteacherpwd\" type=\"password\" class=\"textinput\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"gcteacherpwd\" onFocus=\"this.select(); \" maxlength=\"500\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"2\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<img src=\"/eaie/gcteacher/images/right.gif\"  width=\"222\" height=\"194\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\t\t\t\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"3\">\r\n");
      out.write("\t\t\t\t\t\t<img src=\"/eaie/gcteacher/images/footer.gif\"  width=\"750\" height=\"55\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\t\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t\r\n");
