...
public final class TmstudentListSq_jsp extends org.apache.jasper.runtime.HttpJspBase
...
List list;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\t\t<title>推免生申请信息查询</title>\r\n");
      ...
      out.write("\t\t\t\t\t<nobr>\r\n");
      out.write("\t\t\t\t\t\t");
      out.print((tmstudent.getUsername()==null)?"":tmstudent.getUsername());
      out.write("\r\n");
      out.write("\t\t\t\t\t</nobr></div>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td>\r\n");
