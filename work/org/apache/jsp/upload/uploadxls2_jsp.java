...
public final class uploadxls2_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String sFileName, sFileUrl,sFileSize, sAction;
  ...
  request.setCharacterEncoding("GBK");
	...
	if (sAction == null) {
      ...
      out.write("\r\n");
      out.write("\t<form name=\"upfile\" type=\"file\" method=\"post\" action=\"upload/uploadxls2.jsp?action=save\"\r\n");
      ...
      out.write("\t");
				...
				out.println("上传失败！请重新上传。&nbsp;<A href=\"upload/uploadxls2.jsp\">上传</A>");	
			}	
		}
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t<form name=showfile type=file method=post action=\"upload/uploadxls2.jsp?action=delete\">\t    \r\n");
      out.write("\t\t<table border=0 cellpadding=0 cellspacing=0 align=left width=\"100%\">\r\n");
      out.write("\t\t\t<tr>\t\t\t\t\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t \t");
