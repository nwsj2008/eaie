...
public final class uploadxls3_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String sFileName, sFileUrl,sFileSize, sAction;
  ...
  request.setCharacterEncoding("GBK");
	...
	if (sAction == null) {
      ...
      out.write("\r\n");
      out.write("\t<form name=\"upfile\" type=\"file\" method=\"post\" action=\"upload/uploadxls3.jsp?action=save\"\r\n");
      ...
      out.write("\t");
		...
		if (sAction.equalsIgnoreCase("save")) {
			...
			if (!IsMissing) {
				...
				String FileUrl = "/UploadFiles/upfile/" + "gx.xls";
      ...
      out.write("\t");
				...
				out.println("上传失败！请重新上传。&nbsp;<A href=\"upload/uploadxls3.jsp\">上传</A>");	
			}	
		}
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t<form name=showfile type=file method=post action=\"upload/uploadxls3.jsp?action=delete\">\t    \r\n");
      out.write("\t\t<table border=0 cellpadding=0 cellspacing=0 align=left width=\"100%\">\r\n");
      out.write("\t\t\t<tr>\t\t\t\t\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t \t");
      ...
      out.write("\t");
		...
		if(sAction.equalsIgnoreCase("delete")){			
			...
			if(sFileUrl!=null){
				...
				String filepath = config.getServletContext().getRealPath("/UploadFiles/upfile/"+"gx.xls");				
				...
				if(filetodel.exists()){
					...
					if(delok){	
						...
						out.println(JavaScript.alertandRedirect("删除成功！","uploadxls2.jsp"));	
					}else{						
