...
%>
			...
			<tr>
				<td height="25" background="admin/images/dh_bg.gif" class="menu_title">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td>
								<a href="tmszsxt/main.jsp" target="main"><b>管理首页</b>
								</a> |
								<a href="tmszsxt/logout.jsp" target="_parent"><b>退出</b>
								</a>
							</td>
 ...
 %>
	  			<tr>
        			<td height="20"><a href="tmszsxt/tmnews/TmnewsAdd.jsp" target="main">发布推免生通知</a> | <a href="tmszsxt/tmnews/TmnewsList.jsp" target="main">管理</a></td>
      			</tr>
<%
				//}
...
%>
      			<tr>
          			<td height="20"><a href="tmszsxt/tmstudent/TmstudentListSq.jsp" target="main">查看推免生申请结果</a>
      			</tr>
<%
				//}
...
%>
				...
				<tr>
          			<td height="20"><a href="tmszsxt/tmstudent/TmstudentList.jsp" target="main">添加考核通知和录取信息</a>
        		</tr>
<%
				//}
 ...
 %>
	  			<tr>
        			<td height="20"><a href="tmszsxt/tmstudent/TmstudentListDc.jsp" target="main">导出申请人列表</a></td>
...
%>
	  			...
	  			<tr>
        			<td height="20"><a href="tmszsxt/main.jsp" target="main">系统使用说明</a></td>
      			</tr>
<%
				//}
...
%>
        <tr>
          <td height="20"><a href="admin/users/UserList.jsp" target="main">用户管理</a> <br></td>
        </tr>
<%
				//}
 %>
