...
public final class StmstudentKaohe_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\t\t\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"titlebold2\">查看考核信息</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<BR>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      out.print((tmstudent.getFushiresult() == null) ? ""
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td width=\"150\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      out.print((tmstudent.getShenheresult() == null) ? ""
